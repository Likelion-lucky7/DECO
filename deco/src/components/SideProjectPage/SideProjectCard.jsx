...
const SideProjectCard = ({ title, description, nickname, date, like }) => {
  let fieldProps = {
    frontend: true,
    backend: true,
    designer: true,
  ...
  let { frontend, backend, designer, plan } = fieldProps;
  ...
  let { ts, js, react, figma } = skillProps;
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        {description}
        React 개발자 모집합니다. 많은 문의 바랍니다.React 개발자 모집합니다.
        많은 문의 바랍니다.React 개발자 모집합니다. 많은 문의 바랍니다.많은 문의
        바랍니다.React 개발자 모집합니다. React 개발자 모집합니다. React 개발자
        모집합니다. React 개발자 모집합니다. React 개발자 모집합니다.
      </p>
      ...
      <ul className={styles.field}>
        ...
        {plan == false ? <li style={{ display: "none" }}></li> : <li>기획</li>}
      </ul>
    </div>
  );
};
